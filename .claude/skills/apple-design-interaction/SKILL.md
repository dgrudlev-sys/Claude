...
responds, and *why*. This is the technical/functionality half of Apple design —
...
| `references/flutter-implementation.md` | Flutter/Dart port: Navigator/CupertinoPageRoute/go_router navigation, sheet-detent gaps, shimmer skeletons, optimistic UI, CupertinoSliverRefreshControl, pagination, precacheImage, focus/hit-target sizing |
